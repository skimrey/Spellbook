...
Else IfEqual key0,rtscn, Send countries (actual names{Space}
...
Else IfEqual key0,ekal, Send lake{Space}
...
Else IfEqual key0,pgk, Send keeping{Space}
...
Else IfEqual key0,difc, Send difficult{Space}
Else IfEqual key0,dhln, Send handle{Space}
...
Else IfEqual key0,iom, Send motion{Space}
